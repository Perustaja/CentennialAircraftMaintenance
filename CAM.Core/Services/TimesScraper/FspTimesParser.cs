...
namespace CAM.Core.Services.TimesScraper
{
    ...
    {
        /// <summary>
        /// Takes in labels and values, parses them and converts them from a dictionary to a Times entity.
        /// This is not meant to be generic or reused, it's specific and rigid.
        /// </summary>
        public static Times ParseTimes(List<string> labels, List<string> values)
        {
            ...
            var times = new Times()
            {
                AircraftId = values[0].Substring(0, values[0].IndexOf(" ")),
